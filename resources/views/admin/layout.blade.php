          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link">
                ...
                <div data-i18n="Authentications">Info Desa</div>
              </a>
            </li>
            ...
            <!-- Components -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Perangkat PKK</span></li>
            <!-- Cards -->
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Layouts">Informasi Developer</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
