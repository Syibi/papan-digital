        ...
        <div class="nav-align-top mb-4">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-top-profil" aria-controls="navs-top-home" aria-selected="true">
            ...
            <div class="tab-content">
                    ...
                    <form action="{{ url('/info/addprofil') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mx-3 justify-content-evenly">
                            <div class="mb-1 col-5">
                                ...
                                <input class="form-control-plaintext" type="text" id="profil" name="nama_desa"
                                    readonly="true" {{-- value="{{ $profil['nama_desa'] }}" --}}>
                            </div>
                            <div class="mb-1 col-5">
                                <label for="kode_pos" class="form-label"><strong>Nomer Kode Pos</strong></label>
                                <input class="form-control-plaintext" type="text" id="profil" name="kode_pos"
                                    readonly="true" {{-- value="{{ $profil['kode_pos'] }}" --}}>
                            </div>
                            <div class="mb-1 col-5">
                            ...
                            <div class="mb-1 col-5">
                                ...
                                <input class="form-control-plaintext" type="text" id="profil" name="kecamatan"
                                    readonly="true" {{-- value="{{ $profil['kecamatan'] }}" --}}>
                            </div>
                            <div class="mb-1 col-5">
                            ...
                            <div class="mb-1 col-5">
                                ...
                                <input class="form-control-plaintext" type="text" id="profil" name="kabupaten"
                                    readonly="true" {{-- value="{{ $profil['kabupaten'] }}" --}}>
                            </div>
                            <div class="mb-1 col-5">
                            ...
                            <div class="mb-1 col-5">
                                ...
                                <input class="form-control-plaintext" type="text" id="profil" name="provinsi"
                                    readonly="true" {{-- value="{{ $profil['provinsi'] }}" --}}>
                            </div>
                        </div>
                        <div class="mt-2 float-end">
                            ...
                            <button type="button" class="btn btn-outline-secondary" value="cancel"
                                onclick="nonactive()" id="cancel">Cancel</button>
                ...
                <div class="tab-pane fade" id="navs-top-umum" role="tabpanel">
                    <form action="{{ url('/info/updateumum') }}" method="post" enctype="multipart/form-data"
                        name="form_umum">
                        @csrf
                        @method('PUT')
                        <div class="row justify-content-evenly mx-2">
                            ...
                            <div class="mb-1 col-6">
                                ...
                                <div class="input-group">
                                    <input class="form-control my-1" name="luas_wilayah" type="text"
                                        id="luas_wilayah" {{-- value="{{ $umum['luas_wilayah'] }}" --}}>
                            ...
                            <div>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-5">
                                        <textarea class="form-control my-2" type="text" id="batas_wilayah_utara" name="batas_wilayah_utara"
                                            rows="2">
                                            {{-- {{ $umum['batas_wilayah_utara'] }} --}}
                                        </textarea>
                                    </div>
