                    ...
                    <div class="row justify-content-center text-center mx-2 mt-3">
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="pns" type="text" id="data_pendidikan"
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="tni-polri" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="swasta" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="dagang" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="petani" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="tukang" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="buruh" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="pensiun" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="nelayan" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="peternak" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="jasa" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="seni" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="lain" type="text" id="data_pendidikan"
                                            value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                                ...
                                <div class="user-progress">
                                    <div class="input-group">
                                        <input class="form-control" name="tidak-bekerja" type="text"
                                            id="data_pendidikan" value="{{ $pendidikan['diploma'] }}" readonly>
                                        <span class="input-group-text">Jiwa</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="navs-top-sarana" role="tabpanel">
                    ...
                    <div class="container overflow-hidden text-center">
                        <div class="col-sm-3">
                            <div class="user-progress">
                                <div class="input-group">
                                    <input class="form-control" name="kantor-desa" type="text" id="data_pendidikan"
                                        value="1" readonly>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mt-1 mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="puskesmas" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="poskesdes" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="posyandu" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mt-1 mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="perpus" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="gedung-tk" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mt-1 mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="gedung-sd" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mt-1 mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="masjid" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="musholla" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="gereja" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mt-1 mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="pura" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="vihara" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="kelenteng" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mt-1 mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="olahraga" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="kesenian" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1">
                                            <div class="d-flex w-100 align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="user-progress">
                                                    <div class="input-group">
                                                        <input class="form-control" name="balai" type="text"
                                                            id="data_pendidikan" value="1" readonly>
                                                        <span class="input-group-text">Buah</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <li class="d-flex mb-1 pb-1 align-items-center justify-content-between gap-2">
                                            ...
                                            <div class="user-progress">
                                                <div class="input-group">
                                                    <input class="form-control" name="lainnya" type="text"
                                                        id="data_pendidikan" value="1" readonly>
                                                    <span class="input-group-text">Buah</span>
                                                </div>
                                            </div>
